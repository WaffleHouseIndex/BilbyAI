...
export function TranscriptionTab({ isRecording }: TranscriptionTabProps) {
  ...
  const [calls, setCalls] = useState<Call[]>([
    ...
    },
    {
      ...
      confidence: 89,
      status: 'processing',
      aiSummary: "Family member reporting roommate conflict for William Thompson. Resident appears agitated about television volume dispute and requesting room change.",
      keyPoints: [
        "Roommate disagreement about television volume",
        "Resident requesting room change",
        "William Thompson appears agitated"
      ],
      concerns: ["Roommate conflict", "Resident agitation"]
    }
  ]);
...
${call.transcription}`;
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Search and Stats */}
      <div className="flex items-center gap-4 p-4 pb-2 border-b bg-background sticky top-0 z-10">
                ...
                <div className="space-y-4">
                  ...
                  <Tabs defaultValue="transcription" className="w-full">
                    <TabsList className="grid w-full grid-cols-3">
                      ...
                      <TabsTrigger value="summary" disabled={!call.aiSummary}>
                        <Sparkles className="h-3 w-3 mr-1" />
                        AI Summary
                      </TabsTrigger>
                      <TabsTrigger value="analysis" disabled={!call.keyPoints}>Analysis</TabsTrigger>
                    </TabsList>
